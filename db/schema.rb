...
ActiveRecord::Schema.define(version: 20180727061639) do
  ...
  create_table "slepts", force: :cascade do |t|
    t.integer "user_id"
    t.integer "spot_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "prefecture_id"
    t.integer "spot_count", default: 0
    t.integer "slept_count", default: 0
